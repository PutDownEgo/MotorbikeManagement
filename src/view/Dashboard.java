...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void saveToFile() throws HeadlessException {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            this.sheet = workbook.createSheet("Motorbikes");
            ...
            header.createCell(4).setCellValue("Year of Production");
            header.createCell(5).setCellValue("Price");
            header.createCell(6).setCellValue("Image Path");
            
            for (int i = 0; i < motorbikes.size(); i++) {
                saveToFile(workbook, motorbikes.get(i), i + 1, fileName);
            }
        }
    }
    ...
    private boolean isMissingInformation() {
        if (nameTextField.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Motorbike name is required!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
        if (countryTextField.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Country name is required!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
        if (ccTextField.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Cubic capacity is required!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
        if (yearTextField.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Year of production is required!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
        if (priceTextField.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Motorbike price is required!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
        if (imagePath == null) {
            JOptionPane.showMessageDialog(this, "Motorbike image is required!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
        return false;
    }
...
//    }
    ...
    private void saveToFile(XSSFWorkbook workbook, Motorbike motorbike, int count, String fileName) {

        XSSFSheet sheet = workbook.getSheetAt(0);

        Object[][] bookData = {{count, motorbike.getName(), motorbike.getCountry(), motorbike.getCc(), motorbike.getYearOfProduction(), motorbike.getPrice(), motorbike.getImagePath()}};
